...
// *********************************************************************
{
  if(LCDML.FUNC_setup())          // ****** SETUP *********
  {
    ...
    // update LCD content
    jrlcd.setCursor(0, 0); // set cursor
    jrlcd.print(F("screensaver")); // print change content
    jrlcd.setCursor(0, 1); // set cursor
    jrlcd.print(F("press any key"));
    jrlcd.setCursor(0, 2); // set cursor
    jrlcd.print(F("to leave it"));
